...
def webex_webhook():
    ...
    if resource == "messages":
        ...
        if "nieuwe melding" in text.lower():
            ...
            # normale chat → syncen als note in Halo
