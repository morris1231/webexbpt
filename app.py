...
# ✅ Jouw juiste *Public/Customer Visible Note type ID* uit Halo Config → Action Types
HALO_ACTIONTYPE_PUBLIC = int(os.getenv("HALO_ACTIONTYPE_PUBLIC", "78"))

ticket_room_map = {}  # mapping ticket <-> webex room
