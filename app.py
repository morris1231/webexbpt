...
HALO_ACTIONTYPE_PUBLIC = int(os.getenv("HALO_ACTIONTYPE_PUBLIC", "78"))  # Public Note Action type ID
...
def create_halo_ticket(summary, naam, email,
    ...
    # Beschrijving in ticket
    description = f"👤 Submitted by: {naam} ({email})\n\n📌 Problem: {summary}\n\n"
    ...
    # Vul custom velden in (ReportedUser, ReportedCompany)
    ...
    ref = None
    if ticket_id:
        # extra details ophalen voor referentie
...
def send_adaptive_card(room_id):
    card = {
        "roomId": room_id,
        "markdown": "✍ Vul onderstaande info in om een melding te maken:",
        "attachments": [{
            ...
            "content": {
                ...
                "type":"AdaptiveCard","version":"1.2","body":[
                    ...
                    {"type":"Input.Text","id":"email","placeholder":"Jouw e-mailadres"},
                    {"type":"Input.Text","id":"omschrijving","placeholder":"Probleemomschrijving","isMultiline":True},
                    {"type":"Input.Text","id":"sindswanneer","placeholder":"Sinds wanneer?"},
                    {"type":"Input.Text","id":"watwerktniet","placeholder":"Wat werkt niet?"},
                    {"type":"Input.Text","id":"zelfgeprobeerd","placeholder":"Wat probeerde je al?","isMultiline":True},
                    {"type":"Input.Text","id":"impacttoelichting","placeholder":"Hoe ernstig is dit?","isMultiline":True},
...
def webex_webhook():
    ...
    if resource == "messages":
        ...
        if "nieuwe melding" in text.lower():
            ...
            send_message(room_id, "✍ Vul het formulier hierboven om een ticket te starten.")
        else:
